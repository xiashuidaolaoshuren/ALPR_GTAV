...
def test_position_mapping():
    ...
    print(f"Got:      '{result}'")
    print(f"\nPosition mapping:")
    print(f"  Pos 0 (digit):  O → 0 ✓")
    print(f"  Pos 1 (digit):  I → 1 ✓")
    print(f"  Pos 2 (letter): L → L (no change)")
    print(f"  Pos 3 (letter): B → B (no change)")
    print(f"  Pos 4 (letter): B → B (no change)")
    print(f"  Pos 5 (digit):  B → 8 ✓")
    print(f"  Pos 6 (digit):  S → 5 ✓")
    print(f"  Pos 7 (digit):  S → 5 ✓")
    print(f"  Pos 8 (beyond): G → G (kept as-is)")
