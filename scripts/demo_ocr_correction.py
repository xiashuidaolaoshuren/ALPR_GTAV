...
def demo_correction_impact():
    ...
    print(f"Expected Format: 2 digits + 3 letters + 3 digits (e.g., 12ABC345)")
    print("\n" + "-" * 80)
    ...
    print(f"  - Original success rate: 48.9% (87/178 images)")
    print(f"  - With OCR correction, we expect to recover ~{fixed_count}/{len(failed_ocr_results)} cases")
    print(f"  - Estimated new success rate: ~55-60% (additional 10-20 valid plates)")
