...
class DetectionConfig:
    ...
    def __init__(self, config_dict: Dict[str, Any]):
        ...
        logger.info(f"Detection config loaded: model_path={self.model_path}, "
    ...
    def validate(self) -> bool:
        ...
        if not os.path.exists(self.model_path):
            ...
            raise FileNotFoundError(
                ...
                f"Please download the model or update the path in configs/pipeline_config.yaml"
            )
        ...
        if not 0.0 <= self.iou_threshold <= 1.0:
            raise ValueError(
                f"IOU threshold must be between 0.0 and 1.0, "
    ...
    def __repr__(self) -> str:
        ...
        return (f"DetectionConfig(model_path='{self.model_path}', "
